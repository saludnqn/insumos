...
{
	/// <summary>
	/// Strongly-typed collection for the InsumosPedidosDeuda class.
	/// </summary>
    [Serializable]
	public partial class InsumosPedidosDeudaCollection : ActiveList<InsumosPedidosDeuda, InsumosPedidosDeudaCollection>
	{	   
		public InsumosPedidosDeudaCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>InsumosPedidosDeudaCollection</returns>
		public InsumosPedidosDeudaCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                InsumosPedidosDeuda o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the Insumos_Pedidos_Deudas table.
	/// </summary>
	[Serializable]
	public partial class InsumosPedidosDeuda : ActiveRecord<InsumosPedidosDeuda>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public InsumosPedidosDeuda()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public InsumosPedidosDeuda(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public InsumosPedidosDeuda(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public InsumosPedidosDeuda(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Insumos_Pedidos_Deudas", TableType.Table, DataService.GetInstance("depProvider"));
				...
				colvarEstado.DataType = DbType.Byte;
				...
				TableSchema.TableColumn colvarRazon = new TableSchema.TableColumn(schema);
				colvarRazon.ColumnName = "Razon";
				colvarRazon.DataType = DbType.AnsiString;
				colvarRazon.MaxLength = 200;
				colvarRazon.AutoIncrement = false;
				colvarRazon.IsNullable = true;
				colvarRazon.IsPrimaryKey = false;
				colvarRazon.IsForeignKey = false;
				colvarRazon.IsReadOnly = false;
				colvarRazon.DefaultSetting = @"";
				colvarRazon.ForeignKeyTableName = "";
				schema.Columns.Add(colvarRazon);
				
				BaseSchema = schema;
				//add this schema to the provider
				//so we can query it later
				DataService.Providers["depProvider"].AddSchema("Insumos_Pedidos_Deudas",schema);
			}
		}
		#endregion
		...
		public byte? Estado 
		{
			get { return GetColumnValue<byte?>(Columns.Estado); }
		...
		public string Razon 
		{
			get { return GetColumnValue<string>(Columns.Razon); }
			set { SetColumnValue(Columns.Razon, value); }
		}
		...
		/// <summary>
		/// Returns a InsumosPedido ActiveRecord object related to this InsumosPedidosDeuda
		/// 
		/// </summary>
		...
		/// </summary>
		public static void Insert(int varPedido,DateTime? varFecha,int varInsumo,int varCantidad,byte? varEstado,DateTime? varFechaAutorizacion,int? varAutoridad,int? varNuevoPedido,string varObservaciones,string varRazon)
		{
		...
		/// </summary>
		public static void Update(int varPedido,int varCodigo,DateTime? varFecha,int varInsumo,int varCantidad,byte? varEstado,DateTime? varFechaAutorizacion,int? varAutoridad,int? varNuevoPedido,string varObservaciones,string varRazon)
		{
			InsumosPedidosDeuda item = new InsumosPedidosDeuda();
        ...
        public static TableSchema.TableColumn RazonColumn
        {
		...
		public struct Columns
		{
			 ...
			 public static string Razon = @"Razon";
