...
{
    /// <summary>
    /// Controller class for Insumos
    /// </summary>
    [System.ComponentModel.DataObject]
    public partial class InsumoController
    {
        // Preload our schema..
        Insumo thisSchemaLoad = new Insumo();
        ...
        public InsumoCollection FetchAll()
        {
            InsumoCollection coll = new InsumoCollection();
            Query qry = new Query(Insumo.Schema);
            coll.LoadAndCloseReader(qry.ExecuteReader());
            return coll;
        }
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public InsumoCollection FetchByID(object Codigo)
        {
            InsumoCollection coll = new InsumoCollection().Where("Codigo", Codigo).Load();
            return coll;
        }
		
		[DataObjectMethod(DataObjectMethodType.Select, false)]
        public InsumoCollection FetchByQuery(Query qry)
        {
            InsumoCollection coll = new InsumoCollection();
            coll.LoadAndCloseReader(qry.ExecuteReader()); 
            return coll;
        ...
        {
            return (Insumo.Delete(Codigo) == 1);
        }
        [DataObjectMethod(DataObjectMethodType.Delete, false)]
        public bool Destroy(object Codigo)
        {
            return (Insumo.Destroy(Codigo) == 1);
        }
