...
public partial class PedidosH_ListAsignaStock : System.Web.UI.Page
{
    ...
    protected void btnBuscar_Click(object sender, EventArgs e)
    {
        ...
        DataTable dt = SPs.InsGEtPedidosRealizados(finicio, ffin, dep, rub, aut, idEfector).GetDataSet().Tables[0];
                ...
                case "6":
                    {
                        ...
                        hlE.ToolTip = "Pendiente Preparación";
                    }
                    break;
                case "7":
                    {
