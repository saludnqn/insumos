<%@ Page Title="Listado de Provisiones" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="List.aspx.cs" Inherits="ProvisionesH_List" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Encabezado" runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="Cuerpo" runat="Server">
    <section class="titulo">
        <label>CONSULTAS INGRESOS</label>
    </section>
    <br />
    <div class="container">
            ...
            <div class="panel-body">
                <div class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <label class="control-label col-md-1">Procedencia:</label>
                        <div class="col-md-3">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <asp:DropDownList ID="ddlTipoPedido" runat="server" class="form-control" DataValueField="idTipoPedido" DataTextField="nombre"
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <asp:GridView ID="gvProvisiones" runat="server" AutoGenerateColumns="false" CssClass="table table-hover table-bordered" EmptyDataText="<b>No se encontraron datos.</b>"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="DepositoProveedor" HeaderText="Depósito Proveedor" visible="false"/>
                        <asp:BoundField DataField="Proveedor" HeaderText="Procedencia" />
                        <asp:BoundField DataField="DepositoProveedor" HeaderText="Depósito" />
                        <asp:BoundField DataField="tipoComprobante" HeaderText="Comprobante" />
                        <asp:BoundField DataField="numeroComprobante" HeaderText="N°" />
                        <asp:BoundField DataField="fecha" HeaderText="Fecha" DataFormatString="{0:dd/MM/yyyy}" />
                        <asp:BoundField DataField="fechaRecepcion" HeaderText="Fecha Recepción" DataFormatString="{0:dd/MM/yyyy}" />
