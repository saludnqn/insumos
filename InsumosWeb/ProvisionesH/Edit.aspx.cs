...
public partial class ProvisionesH_Edit : System.Web.UI.Page
{
    ...
    private void cargarCombos()
    {
        ...
        dllTipoPedido.Items.Insert(0, new ListItem("Seleccionar", "0"));
        var tipoPedidoSelected = tp.ExecuteTypedList<InsTipoPedido>().Where(w => w.Selected).FirstOrDefault();
        if (tipoPedidoSelected != null)
            dllTipoPedido.Items.FindByValue(tipoPedidoSelected.IdTipoPedido.ToString()).Selected = true;
    ...
    protected void btnAgregarInsumo_Click(object sender, EventArgs e)
    {
        ...
        //Se permiten ingresar el mismo insumo porque pueden ser de distinto lote y vto
        //int idNuevoInsumo = acInsumo.getInsumo();
    ...
    protected void btnGuardar_Click(object sender, EventArgs e)
    {
        ...
        if ((true) && (ValidaDesdeServidor()))
        {
            ...
            p.IdTipoPedido = Convert.ToInt32(dllTipoPedido.SelectedValue);
            ...
            p.IdRubro = 1;  //Convert.ToInt32(ddlRubro.SelectedValue);   0; Relacion debil con el rubro
            ...
            Response.Redirect("ViewInterno.aspx?id=" + p.IdPedido.ToString() + "&valor=1");
        }
        else
        {
    ...
    protected void lbCalcular_Click(object sender, EventArgs e)
    {
        ...
        int Cant = (Convert.ToInt32(((TextBox)gvr.FindControl("txtCantidad")).Text));
        int Presentacion = (Convert.ToInt32(((TextBox)gvr.FindControl("txtPresentacion")).Text));
        int Total = Cant * Presentacion;

        ((Label)gvr.FindControl("lblCantidadR")).Text = Total.ToString();        
    }
