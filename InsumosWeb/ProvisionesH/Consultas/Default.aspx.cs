...
public partial class ProvisionesH_Consultas_Default : System.Web.UI.Page
{
    ...
    private void LeerDatos()
    {
        ...
        DataTable dt = SPs.InsTopProvisiones(idEfector, dep, finicio, ffin).GetDataSet().Tables[0];

        //configuracoes de titulos
        hcMedicamentos.Title = new Title("10 Insumos mas ingresados en el Depósito");
        ...
        hcMedicamentos.PlotOptions = new Highchart.Core.PlotOptions.PlotOptionsPie { borderColor = "#dedede", animation = true };
