<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="Consultas.aspx.cs" Inherits="Recetas_Consultas" %>
        ...
        <div class="container">        
                ...
                <ContentTemplate>
                    ...
                    <div class="contentBoxW">
                        <asp:GridView ID="gvRecetas" runat="server" CssClass="table table-hover table-condensed table-bordered" AutoGenerateColumns="false" PagerStyle-CssClass="pager" AllowPaging="True" OnPageIndexChanging="gvRecetas_PageIndexChanging" PageSize="20"
                            ToolTip="Recetas Ambulatorias encontradas. Ordenadas por Fecha Desc." EmptyDataText="Sin registros" OnRowDataBound="gvRecetas_RowDataBound">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Receta">
                                    <ItemTemplate>
                                        <a href="VerReceta.aspx?id=<%# Eval("IdPrescripcion") %>" Class="btn btn-default btn-md"
                                ...
                                <asp:TemplateField HeaderText="Duplicar" Visible="false">
                                    <ItemTemplate>
                                        <a href="Edit.aspx?dpl=si&id={0}<%# Eval("IdPrescripcion") %>" Class="btn btn-default btn-md"
                                            target="_blank" title="Duplicación Receta" onclick="window.open(this.href, this.target, 'width=1100,height=800,scrollbars=yes,top=20, left=20'); return false;">
                                            <span> <i class="glyphicon glyphicon-share"> </i> </span>
                                        </a>                                                                                                                    
                                    </ItemTemplate>
                                </asp:TemplateField>

                                <asp:TemplateField HeaderText="Dispensar" Visible="false">
                                    <ItemTemplate>
                                        ...
                                        <tr>
                                            <td colspan="99%">
                                                <div id="div<%# Eval("idPrescripcion") %>" style="display: none; position: relative; left: 2px;">
                                                    <asp:GridView ID="gvDispensacionReceta" runat="server" DataKeyNames="idPrescripcion" CssClass="table table-bordered table-condensed table-hover"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField DataField="idDispensacion" HeaderText="Dispensación N°" />
                                                            ...
                                                            <asp:TemplateField HeaderText="Dispensación">
                                                                <ItemTemplate>
