<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="InternacionView.aspx.cs" Inherits="Recetas_InternacionView" %>
...
<%--                    Tratamiento:
                 ...
                 &nbsp;&nbsp;&nbsp;&nbsp;   
                <asp:LinkButton ID="lbImprimir" runat="server" ToolTip="Exportar e Imprimir" OnClick="lbImprimir_Click">Imprimir</asp:LinkButton>
                </td>
            </tr>
            <tr>
                <td colspan="3">
        ...
        <div class="contentBoxW">
            <asp:GridView ID="gvReceta" runat="server" CellPadding="2" CssClass="mGrid" AutoGenerateColumns="false">
                <Columns>
                    ...
                    <asp:BoundField DataField="frecuencia" HeaderText="Frecuencia Hs" />
                    <asp:TemplateField HeaderText="Emitido">
                        <ItemTemplate>
                            <asp:Label ID="lblEntregado" runat="server" Text='<%# Eval("CantidadEmitida") %>' />
                        </ItemTemplate>
                    </asp:TemplateField>                   
                    <asp:BoundField DataField="observacion" HeaderText="Tratamiento" />
...
&nbsp;&nbsp;&nbsp;
   ...
   <%-- &nbsp;&nbsp;&nbsp;
    <asp:Button ID="btnPedido" runat="server" Text="Generar Pedido" OnClick="btnPedido_Click"
