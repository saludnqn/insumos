...
{
	/// <summary>
	/// Strongly-typed collection for the PdProfe class.
	/// </summary>
    [Serializable]
	public partial class PdProfeCollection : ActiveList<PdProfe, PdProfeCollection>
	{	   
		public PdProfeCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>PdProfeCollection</returns>
		public PdProfeCollection Filter()
        {
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the Pd_Profe table.
	/// </summary>
	[Serializable]
	public partial class PdProfe : ActiveRecord<PdProfe>, IActiveRecord
	{
		...
		public PdProfe(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public PdProfe(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Pd_Profe", TableType.Table, DataService.GetInstance("padronProvider"));
				...
				DataService.Providers["padronProvider"].AddSchema("Pd_Profe",schema);
			}
		}
		#endregion
