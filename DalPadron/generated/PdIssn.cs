...
{
	/// <summary>
	/// Strongly-typed collection for the PdIssn class.
	/// </summary>
    [Serializable]
	public partial class PdIssnCollection : ActiveList<PdIssn, PdIssnCollection>
	{	   
		public PdIssnCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>PdIssnCollection</returns>
		public PdIssnCollection Filter()
        {
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the Pd_Issn table.
	/// </summary>
	[Serializable]
	public partial class PdIssn : ActiveRecord<PdIssn>, IActiveRecord
	{
		...
		public PdIssn(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public PdIssn(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Pd_Issn", TableType.Table, DataService.GetInstance("padronProvider"));
				...
				DataService.Providers["padronProvider"].AddSchema("Pd_Issn",schema);
			}
		}
		#endregion
