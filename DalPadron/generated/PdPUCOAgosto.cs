...
{
	/// <summary>
	/// Strongly-typed collection for the PdPUCOAgosto class.
	/// </summary>
    [Serializable]
	public partial class PdPUCOAgostoCollection : ActiveList<PdPUCOAgosto, PdPUCOAgostoCollection>
	{	   
		public PdPUCOAgostoCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>PdPUCOAgostoCollection</returns>
		public PdPUCOAgostoCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                PdPUCOAgosto o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the Pd_PUCOAgosto table.
	/// </summary>
	[Serializable]
	public partial class PdPUCOAgosto : ActiveRecord<PdPUCOAgosto>, IActiveRecord
	{
		...
		public PdPUCOAgosto(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public PdPUCOAgosto(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public PdPUCOAgosto(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Pd_PUCOAgosto", TableType.Table, DataService.GetInstance("padronProvider"));
				...
				DataService.Providers["padronProvider"].AddSchema("Pd_PUCOAgosto",schema);
			}
		}
		#endregion
