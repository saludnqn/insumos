...
{
	/// <summary>
	/// Strongly-typed collection for the PdIssn2 class.
	/// </summary>
    [Serializable]
	public partial class PdIssn2Collection : ActiveList<PdIssn2, PdIssn2Collection>
	{	   
		public PdIssn2Collection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>PdIssn2Collection</returns>
		public PdIssn2Collection Filter()
        {
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the Pd_Issn2 table.
	/// </summary>
	[Serializable]
	public partial class PdIssn2 : ActiveRecord<PdIssn2>, IActiveRecord
	{
		...
		public PdIssn2(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public PdIssn2(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Pd_Issn2", TableType.Table, DataService.GetInstance("padronProvider"));
				...
				DataService.Providers["padronProvider"].AddSchema("Pd_Issn2",schema);
			}
		}
		#endregion
