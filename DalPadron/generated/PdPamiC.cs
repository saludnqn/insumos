...
{
	/// <summary>
	/// Strongly-typed collection for the PdPamiC class.
	/// </summary>
    [Serializable]
	public partial class PdPamiCCollection : ActiveList<PdPamiC, PdPamiCCollection>
	{	   
		public PdPamiCCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>PdPamiCCollection</returns>
		public PdPamiCCollection Filter()
        {
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the Pd_PamiC table.
	/// </summary>
	[Serializable]
	public partial class PdPamiC : ActiveRecord<PdPamiC>, IActiveRecord
	{
		...
		public PdPamiC(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public PdPamiC(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Pd_PamiC", TableType.Table, DataService.GetInstance("padronProvider"));
				...
				colvarNroAfiliado.DataType = DbType.Int64;
				...
				DataService.Providers["padronProvider"].AddSchema("Pd_PamiC",schema);
			}
		}
		#endregion
		...
		[Bindable(true)]
		public long? NroAfiliado 
		{
			get { return GetColumnValue<long?>(Columns.NroAfiliado); }
		...
		/// </summary>
		public static void Insert(string varNombre,int varDocumento,string varTipoDocumento,DateTime? varFechaIngreso,long? varNroAfiliado)
		{
		...
		/// </summary>
		public static void Update(int varId,string varNombre,int varDocumento,string varTipoDocumento,DateTime? varFechaIngreso,long? varNroAfiliado)
		{
			PdPamiC item = new PdPamiC();
