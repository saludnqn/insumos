...
namespace DalInsumos
{
	...
	public partial class SysRelEstadoMotivoNI : ActiveRecord<SysRelEstadoMotivoNI>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Sys_RelEstadoMotivoNI", TableType.Table, DataService.GetInstance("insProvider"));
				...
				DataService.Providers["insProvider"].AddSchema("Sys_RelEstadoMotivoNI",schema);
			}
		}
		#endregion
