...
namespace DalInsumos
{
	...
	public partial class SysOcupacion : ActiveRecord<SysOcupacion>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Sys_Ocupacion", TableType.Table, DataService.GetInstance("insProvider"));
				...
				DataService.Providers["insProvider"].AddSchema("Sys_Ocupacion",schema);
			}
		}
		#endregion
		...
		public DalInsumos.SysPacienteCollection SysPacienteRecords
		{
			get
			{
				...
				{
					colSysPacienteRecords = new DalInsumos.SysPacienteCollection().Where(SysPaciente.Columns.IdOcupacion, IdOcupacion).Load();
		...
		void colSysPacienteRecords_ListChanged(object sender, ListChangedEventArgs e)
		{
		    if (e.ListChangedType == ListChangedType.ItemAdded)
		    {
		        ...
		        colSysPacienteRecords[e.NewIndex].IdOcupacion = IdOcupacion;
		    }
		}
        ...
        public void SetPKValues()
        {
                if (colSysPacienteRecords != null)
                {
                    ...
                    {
                        if (item.IdOcupacion != IdOcupacion)
                        {
