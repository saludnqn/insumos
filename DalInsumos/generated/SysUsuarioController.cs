...
namespace DalInsumos
{
    ...
    public partial class SysUsuarioController
    {
	    ...
	    public void Insert(int IdEfector,int IdPerfil,string Apellido,string Nombre,string Legajo,string Username,string Password,bool Activo,int IdUsuarioActualizacion,DateTime FechaActualizacion,string FirmaValidacion,string Email,string Telefono,string Observacion,int Documento)
	    {
            ...
            item.FirmaValidacion = FirmaValidacion;
	    ...
	    public void Update(int IdUsuario,int IdEfector,int IdPerfil,string Apellido,string Nombre,string Legajo,string Username,string Password,bool Activo,int IdUsuarioActualizacion,DateTime FechaActualizacion,string FirmaValidacion,string Email,string Telefono,string Observacion,int Documento)
	    {
		    SysUsuario item = new SysUsuario();
	        item.MarkOld();
	        item.IsLoaded = true;
