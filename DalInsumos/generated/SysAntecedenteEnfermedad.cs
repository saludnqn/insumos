...
namespace DalInsumos
{
	...
	public partial class SysAntecedenteEnfermedad : ActiveRecord<SysAntecedenteEnfermedad>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Sys_AntecedenteEnfermedad", TableType.Table, DataService.GetInstance("insProvider"));
				...
				colvarCODCIE10.ForeignKeyTableName = "";
				schema.Columns.Add(colvarCODCIE10);
				
				BaseSchema = schema;
				//add this schema to the provider
				//so we can query it later
				DataService.Providers["insProvider"].AddSchema("Sys_AntecedenteEnfermedad",schema);
			}
		}
		#endregion
