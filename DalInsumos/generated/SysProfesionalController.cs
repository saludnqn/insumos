...
namespace DalInsumos
{
    ...
    public partial class SysProfesionalController
    {
	    ...
	    public void Insert(int IdEfector,string Apellido,string Nombre,int IdTipoDocumento,int NumeroDocumento,string Matricula,int IdUsuario,DateTime FechaModificacion,bool Activo,string Legajo,string CodigoSISA,string NombreCompleto,string ApellidoyNombre,int IdTipoProfesional,string Mail,string Telefono,string CreatedBy,DateTime CreatedOn,string ModifiedBy,DateTime ModifiedOn)
	    {
