...
namespace DalInsumos
{
	...
	public partial class SysRelFormularioCobertura : ActiveRecord<SysRelFormularioCobertura>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Sys_RelFormularioCobertura", TableType.Table, DataService.GetInstance("insProvider"));
				...
				DataService.Providers["insProvider"].AddSchema("Sys_RelFormularioCobertura",schema);
			}
		}
		#endregion
