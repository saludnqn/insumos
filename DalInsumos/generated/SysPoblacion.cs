...
namespace DalInsumos
{
	...
	public partial class SysPoblacion : ActiveRecord<SysPoblacion>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Sys_Poblacion", TableType.Table, DataService.GetInstance("insProvider"));
				...
				DataService.Providers["insProvider"].AddSchema("Sys_Poblacion",schema);
			}
		}
		#endregion
