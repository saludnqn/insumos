...
namespace DalInsumos
{
	...
	public partial class SysTipoEfector : ActiveRecord<SysTipoEfector>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Sys_TipoEfector", TableType.Table, DataService.GetInstance("insProvider"));
				...
				DataService.Providers["insProvider"].AddSchema("Sys_TipoEfector",schema);
			}
		}
		#endregion
