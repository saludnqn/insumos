...
namespace DalInsumos
{
	...
	public partial class SysBarrio : ActiveRecord<SysBarrio>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Sys_Barrio", TableType.Table, DataService.GetInstance("insProvider"));
				...
				DataService.Providers["insProvider"].AddSchema("Sys_Barrio",schema);
			}
		}
		#endregion
