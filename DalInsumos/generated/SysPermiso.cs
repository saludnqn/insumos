...
namespace DalInsumos
{
	...
	public partial class SysPermiso : ActiveRecord<SysPermiso>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Sys_Permiso", TableType.Table, DataService.GetInstance("insProvider"));
				...
				DataService.Providers["insProvider"].AddSchema("Sys_Permiso",schema);
			}
		}
		#endregion
