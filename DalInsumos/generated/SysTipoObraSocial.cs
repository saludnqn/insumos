...
namespace DalInsumos
{
	...
	public partial class SysTipoObraSocial : ActiveRecord<SysTipoObraSocial>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Sys_TipoObraSocial", TableType.Table, DataService.GetInstance("insProvider"));
				...
				DataService.Providers["insProvider"].AddSchema("Sys_TipoObraSocial",schema);
			}
		}
		#endregion
