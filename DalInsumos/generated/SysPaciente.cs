...
namespace DalInsumos
{
	...
	public partial class SysPaciente : ActiveRecord<SysPaciente>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Sys_Paciente", TableType.Table, DataService.GetInstance("insProvider"));
				...
				colvarHistoriaClinica.IsReadOnly = false;
						...
						colvarHistoriaClinica.DefaultSetting = @"((0))";
				...
				DataService.Providers["insProvider"].AddSchema("Sys_Paciente",schema);
			}
		}
		#endregion
		...
		public DalInsumos.InsDispensacionCollection InsDispensacionRecords
		{
			get
			{
				...
				{
					colInsDispensacionRecords = new DalInsumos.InsDispensacionCollection().Where(InsDispensacion.Columns.IdPaciente, IdPaciente).Load();
		...
		void colInsDispensacionRecords_ListChanged(object sender, ListChangedEventArgs e)
		{
		    if (e.ListChangedType == ListChangedType.ItemAdded)
		    {
		        ...
		        colInsDispensacionRecords[e.NewIndex].IdPaciente = IdPaciente;
		    }
		}
		...
		public DalInsumos.InsPrescripcionCollection InsPrescripcionRecords
		{
			get
			{
				...
				{
					colInsPrescripcionRecords = new DalInsumos.InsPrescripcionCollection().Where(InsPrescripcion.Columns.IdPaciente, IdPaciente).Load();
		...
		void colInsPrescripcionRecords_ListChanged(object sender, ListChangedEventArgs e)
		{
		    ...
		    {
		        // Set foreign key value
		        colInsPrescripcionRecords[e.NewIndex].IdPaciente = IdPaciente;
		    }
		}
		...
		public DalInsumos.InsRecetumCollection InsReceta
		{
			get
			{
				...
				{
					colInsReceta = new DalInsumos.InsRecetumCollection().Where(InsRecetum.Columns.IdPaciente, IdPaciente).Load();
		...
		void colInsReceta_ListChanged(object sender, ListChangedEventArgs e)
		{
		    ...
		    {
		        // Set foreign key value
		        colInsReceta[e.NewIndex].IdPaciente = IdPaciente;
		    }
		}
				
		private DalInsumos.SysAntecedenteEnfermedadCollection colSysAntecedenteEnfermedadRecords;
		public DalInsumos.SysAntecedenteEnfermedadCollection SysAntecedenteEnfermedadRecords
		{
			get
			{
				if(colSysAntecedenteEnfermedadRecords == null)
				{
					colSysAntecedenteEnfermedadRecords = new DalInsumos.SysAntecedenteEnfermedadCollection().Where(SysAntecedenteEnfermedad.Columns.IdPaciente, IdPaciente).Load();
		...
		private DalInsumos.SysRelAntecedentePacienteCollection colSysRelAntecedentePacienteRecords;
		public DalInsumos.SysRelAntecedentePacienteCollection SysRelAntecedentePacienteRecords
		{
			get
			{
				if(colSysRelAntecedentePacienteRecords == null)
				{
					colSysRelAntecedentePacienteRecords = new DalInsumos.SysRelAntecedentePacienteCollection().Where(SysRelAntecedentePaciente.Columns.IdPaciente, IdPaciente).Load();
		...
		private DalInsumos.SysHistoriaClinicaCollection colSysHistoriaClinicaRecords;
		public DalInsumos.SysHistoriaClinicaCollection SysHistoriaClinicaRecords
		{
			get
			{
				if(colSysHistoriaClinicaRecords == null)
				{
					colSysHistoriaClinicaRecords = new DalInsumos.SysHistoriaClinicaCollection().Where(SysHistoriaClinica.Columns.IdPaciente, IdPaciente).Load();
		...
		public DalInsumos.SysRelHistoriaClinicaEfectorCollection SysRelHistoriaClinicaEfectorRecords
		{
			get
			{
				...
				{
					colSysRelHistoriaClinicaEfectorRecords = new DalInsumos.SysRelHistoriaClinicaEfectorCollection().Where(SysRelHistoriaClinicaEfector.Columns.IdPaciente, IdPaciente).Load();
		...
		public DalInsumos.SysRelPacienteObraSocialCollection SysRelPacienteObraSocialRecords
		{
			get
			{
				...
				{
					colSysRelPacienteObraSocialRecords = new DalInsumos.SysRelPacienteObraSocialCollection().Where(SysRelPacienteObraSocial.Columns.IdPaciente, IdPaciente).Load();
		...
		/// 
		/// </summary>
		public DalInsumos.SysOcupacion SysOcupacion
		{
			get { return DalInsumos.SysOcupacion.FetchByID(this.IdOcupacion); }
		...
		/// 
		/// </summary>
		public DalInsumos.SysLocalidad SysLocalidad
		{
			get { return DalInsumos.SysLocalidad.FetchByID(this.IdLocalidad); }
		...
		/// 
		/// </summary>
		public DalInsumos.SysEstadoCivil SysEstadoCivil
		{
			get { return DalInsumos.SysEstadoCivil.FetchByID(this.IdEstadoCivil); }
		...
		/// 
		/// </summary>
		public DalInsumos.SysMotivoNI SysMotivoNI
		{
			get { return DalInsumos.SysMotivoNI.FetchByID(this.IdMotivoNI); }
		...
		/// 
		/// </summary>
		public DalInsumos.SysDepartamento SysDepartamento
		{
			get { return DalInsumos.SysDepartamento.FetchByID(this.IdDepartamento); }
		...
		/// 
		/// </summary>
		public DalInsumos.SysEstado SysEstado
		{
			get { return DalInsumos.SysEstado.FetchByID(this.IdEstado); }
		...
		/// 
		/// </summary>
		public DalInsumos.SysProvincium SysProvinciumToIdProvinciaDomicilio
		{
			get { return DalInsumos.SysProvincium.FetchByID(this.IdProvinciaDomicilio); }
		...
		/// 
		/// </summary>
		public DalInsumos.SysSexo SysSexo
		{
			get { return DalInsumos.SysSexo.FetchByID(this.IdSexo); }
		...
		/// </summary>
		public static void Insert(int varIdEfector,int varHistoriaClinica,string varApellido,string varNombre,int varNumeroDocumento,int varIdSexo,DateTime varFechaNacimiento,int varIdEstado,int varIdMotivoNI,int varIdPais,int varIdProvincia,int varIdNivelInstruccion,int varIdSituacionLaboral,int varIdProfesion,int varIdOcupacion,string varCalle,int varNumero,string varPiso,string varDepartamento,string varManzana,int varIdBarrio,int varIdLocalidad,int varIdDepartamento,int varIdProvinciaDomicilio,string varReferencia,string varInformacionContacto,bool varCronico,int varIdObraSocial,int varIdUsuario,DateTime varFechaAlta,DateTime varFechaDefuncion,DateTime varFechaUltimaActualizacion,int varIdEstadoCivil,bool varActivo,int varIdEtnia,int varIdPoblacion,int varIdIdioma,string varOtroBarrio,string varCamino,string varCampo,bool varEsUrbano,string varLote,string varParcela,string varEdificio,DateTime? varFechaAltaObraSocial,string varNumeroAfiliado,string varNumeroExtranjero,string varTelefonoFijo,string varTelefonoCelular,string varEmail,string varLatitud,string varLongitud)
		{
		...
		/// </summary>
		public static void Update(int varIdPaciente,int varIdEfector,int varHistoriaClinica,string varApellido,string varNombre,int varNumeroDocumento,int varIdSexo,DateTime varFechaNacimiento,int varIdEstado,int varIdMotivoNI,int varIdPais,int varIdProvincia,int varIdNivelInstruccion,int varIdSituacionLaboral,int varIdProfesion,int varIdOcupacion,string varCalle,int varNumero,string varPiso,string varDepartamento,string varManzana,int varIdBarrio,int varIdLocalidad,int varIdDepartamento,int varIdProvinciaDomicilio,string varReferencia,string varInformacionContacto,bool varCronico,int varIdObraSocial,int varIdUsuario,DateTime varFechaAlta,DateTime varFechaDefuncion,DateTime varFechaUltimaActualizacion,int varIdEstadoCivil,bool varActivo,int varIdEtnia,int varIdPoblacion,int varIdIdioma,string varOtroBarrio,string varCamino,string varCampo,bool varEsUrbano,string varLote,string varParcela,string varEdificio,DateTime? varFechaAltaObraSocial,string varNumeroAfiliado,string varNumeroExtranjero,string varTelefonoFijo,string varTelefonoCelular,string varEmail,string varLatitud,string varLongitud)
		{
			SysPaciente item = new SysPaciente();
        ...
        public void SetPKValues()
        {
                ...
                if (colSysAntecedenteEnfermedadRecords != null)
                {
                    foreach (DalInsumos.SysAntecedenteEnfermedad item in colSysAntecedenteEnfermedadRecords)
                    {
                ...
                if (colSysRelAntecedentePacienteRecords != null)
                {
                    foreach (DalInsumos.SysRelAntecedentePaciente item in colSysRelAntecedentePacienteRecords)
                    {
                        if (item.IdPaciente == null ||item.IdPaciente != IdPaciente)
                        {
                            item.IdPaciente = IdPaciente;
                ...
                if (colSysHistoriaClinicaRecords != null)
                {
                    foreach (DalInsumos.SysHistoriaClinica item in colSysHistoriaClinicaRecords)
                    {
                        if (item.IdPaciente == null ||item.IdPaciente != IdPaciente)
                        {
                            item.IdPaciente = IdPaciente;
