...
namespace DalInsumos
{
	...
	public partial class SysZona : ActiveRecord<SysZona>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Sys_Zona", TableType.Table, DataService.GetInstance("insProvider"));
				...
				DataService.Providers["insProvider"].AddSchema("Sys_Zona",schema);
			}
		}
		#endregion
		...
		/// <summary>
		/// Returns a SysLocalidad ActiveRecord object related to this SysZona
		/// 
		/// </summary>
