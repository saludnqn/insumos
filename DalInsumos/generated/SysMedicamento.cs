...
namespace DalInsumos
{
	...
	public partial class SysMedicamento : ActiveRecord<SysMedicamento>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Sys_Medicamento", TableType.Table, DataService.GetInstance("insProvider"));
				...
				DataService.Providers["insProvider"].AddSchema("Sys_Medicamento",schema);
			}
		}
		#endregion
		...
		/// 
		/// </summary>
		public DalInsumos.SysMedicamentoRubro SysMedicamentoRubro
		{
			get { return DalInsumos.SysMedicamentoRubro.FetchByID(this.IdMedicamentoRubro); }
