...
namespace DalInsumos
{
	...
	public partial class SysEstadoCivil : ActiveRecord<SysEstadoCivil>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Sys_EstadoCivil", TableType.Table, DataService.GetInstance("insProvider"));
				...
				DataService.Providers["insProvider"].AddSchema("Sys_EstadoCivil",schema);
			}
		}
		#endregion
		...
		public DalInsumos.SysPacienteCollection SysPacienteRecords
		{
			get
			{
				...
				{
					colSysPacienteRecords = new DalInsumos.SysPacienteCollection().Where(SysPaciente.Columns.IdEstadoCivil, IdEstadoCivil).Load();
		...
		void colSysPacienteRecords_ListChanged(object sender, ListChangedEventArgs e)
		{
		    if (e.ListChangedType == ListChangedType.ItemAdded)
		    {
		        ...
		        colSysPacienteRecords[e.NewIndex].IdEstadoCivil = IdEstadoCivil;
		    }
		}
        ...
        public void SetPKValues()
        {
                if (colSysPacienteRecords != null)
                {
                    ...
                    {
                        if (item.IdEstadoCivil != IdEstadoCivil)
                        {
