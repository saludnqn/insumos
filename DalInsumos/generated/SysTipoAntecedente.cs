...
namespace DalInsumos
{
	...
	public partial class SysTipoAntecedente : ActiveRecord<SysTipoAntecedente>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Sys_TipoAntecedente", TableType.Table, DataService.GetInstance("insProvider"));
				...
				DataService.Providers["insProvider"].AddSchema("Sys_TipoAntecedente",schema);
			}
		}
		#endregion
