...
{
	/// <summary>
	/// Strongly-typed collection for the InsDispensacionDetalle class.
	/// </summary>
    [Serializable]
	public partial class InsDispensacionDetalleCollection : ActiveList<InsDispensacionDetalle, InsDispensacionDetalleCollection>
	{	   
		public InsDispensacionDetalleCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>InsDispensacionDetalleCollection</returns>
		public InsDispensacionDetalleCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                InsDispensacionDetalle o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the INS_DispensacionDetalle table.
	/// </summary>
	[Serializable]
	public partial class InsDispensacionDetalle : ActiveRecord<InsDispensacionDetalle>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public InsDispensacionDetalle()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public InsDispensacionDetalle(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public InsDispensacionDetalle(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public InsDispensacionDetalle(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("INS_DispensacionDetalle", TableType.Table, DataService.GetInstance("insProvider"));
				...
				colvarIdDispensacionDetalle.AutoIncrement = true;
				colvarIdDispensacionDetalle.IsNullable = false;
				colvarIdDispensacionDetalle.IsPrimaryKey = true;
				colvarIdDispensacionDetalle.IsForeignKey = false;
				colvarIdDispensacionDetalle.IsReadOnly = false;
				colvarIdDispensacionDetalle.DefaultSetting = @"";
				colvarIdDispensacionDetalle.ForeignKeyTableName = "";
				...
				colvarIdDispensacion.AutoIncrement = false;
				colvarIdDispensacion.IsNullable = true;
				colvarIdDispensacion.IsPrimaryKey = false;
				colvarIdDispensacion.IsForeignKey = true;
				colvarIdDispensacion.IsReadOnly = false;
				colvarIdDispensacion.DefaultSetting = @"";
				
					colvarIdDispensacion.ForeignKeyTableName = "INS_Dispensacion";
				...
				DataService.Providers["insProvider"].AddSchema("INS_DispensacionDetalle",schema);
			}
		}
		#endregion
		...
		public DalInsumos.InsDispensacionEntregaCollection InsDispensacionEntregaRecords
		{
			get
			{
				...
				{
					colInsDispensacionEntregaRecords = new DalInsumos.InsDispensacionEntregaCollection().Where(InsDispensacionEntrega.Columns.IdDispensacionDetalle, IdDispensacionDetalle).Load();
		...
		void colInsDispensacionEntregaRecords_ListChanged(object sender, ListChangedEventArgs e)
		{
		    if (e.ListChangedType == ListChangedType.ItemAdded)
		    {
		        ...
		        colInsDispensacionEntregaRecords[e.NewIndex].IdDispensacionDetalle = IdDispensacionDetalle;
		    }
		}
		...
		/// <summary>
		/// Returns a InsInsumo ActiveRecord object related to this InsDispensacionDetalle
		/// 
		/// </summary>
		...
		/// <summary>
		/// Returns a InsInternacionPedido ActiveRecord object related to this InsDispensacionDetalle
		/// 
		/// </summary>
		...
		/// <summary>
		/// Returns a InsMotivosRechazo ActiveRecord object related to this InsDispensacionDetalle
		/// 
		/// </summary>
		...
		/// <summary>
		/// Returns a InsDispensacion ActiveRecord object related to this InsDispensacionDetalle
		/// 
		/// </summary>
		public DalInsumos.InsDispensacion InsDispensacion
		{
			get { return DalInsumos.InsDispensacion.FetchByID(this.IdDispensacion); }
			set { SetColumnValue("idDispensacion", value.IdDispensacion); }
		}
		
		
		/// <summary>
		/// Returns a InsDosi ActiveRecord object related to this InsDispensacionDetalle
		/// 
		/// </summary>
		...
		/// </summary>
		public static void Insert(int? varIdDispensacion,int? varIdInsumo,DateTime? varFecha,int? varRenglon,string varUnidadDosis,int? varDiasTratamiento,int? varCantidadSolicitada,int? varCantidadEmitida,string varFrecuencia,string varObservacion,bool varBaja,int varIdInternacionPedido,int? varIdMotivoRechazo,string varObservacionRechazo,int varIdDosis,string varCreatedBy,DateTime varCreatedOn,string varModifiedBy,DateTime varModifiedOn,int? varCantidadDisponible,int varDeuda,decimal varDosis)
		{
		...
		/// </summary>
		public static void Update(int varIdDispensacionDetalle,int? varIdDispensacion,int? varIdInsumo,DateTime? varFecha,int? varRenglon,string varUnidadDosis,int? varDiasTratamiento,int? varCantidadSolicitada,int? varCantidadEmitida,string varFrecuencia,string varObservacion,bool varBaja,int varIdInternacionPedido,int? varIdMotivoRechazo,string varObservacionRechazo,int varIdDosis,string varCreatedBy,DateTime varCreatedOn,string varModifiedBy,DateTime varModifiedOn,int? varCantidadDisponible,int varDeuda,decimal varDosis)
		{
			InsDispensacionDetalle item = new InsDispensacionDetalle();
        ...
        public void SetPKValues()
        {
                if (colInsDispensacionEntregaRecords != null)
                {
                    ...
                    {
                        if (item.IdDispensacionDetalle != IdDispensacionDetalle)
                        {
