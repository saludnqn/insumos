...
namespace DalInsumos
{
	...
	public partial class SysMovimientoHistoriaClinica : ActiveRecord<SysMovimientoHistoriaClinica>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Sys_MovimientoHistoriaClinica", TableType.Table, DataService.GetInstance("insProvider"));
				...
				DataService.Providers["insProvider"].AddSchema("Sys_MovimientoHistoriaClinica",schema);
			}
		}
		#endregion
