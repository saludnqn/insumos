...
namespace DalInsumos
{
	...
	public partial class InsTipoPrescripcion : ActiveRecord<InsTipoPrescripcion>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("INS_TipoPrescripcion", TableType.Table, DataService.GetInstance("insProvider"));
				...
				DataService.Providers["insProvider"].AddSchema("INS_TipoPrescripcion",schema);
			}
		}
		#endregion
		...
		public DalInsumos.InsDispensacionCollection InsDispensacionRecords
		{
			get
			{
				...
				{
					colInsDispensacionRecords = new DalInsumos.InsDispensacionCollection().Where(InsDispensacion.Columns.IdTipoPrescripcion, IdTipoPrescripcion).Load();
		...
		void colInsDispensacionRecords_ListChanged(object sender, ListChangedEventArgs e)
		{
		    if (e.ListChangedType == ListChangedType.ItemAdded)
		    {
		        ...
		        colInsDispensacionRecords[e.NewIndex].IdTipoPrescripcion = IdTipoPrescripcion;
		    }
		}
		...
		public DalInsumos.InsPrescripcionCollection InsPrescripcionRecords
		{
			get
			{
				...
				{
					colInsPrescripcionRecords = new DalInsumos.InsPrescripcionCollection().Where(InsPrescripcion.Columns.IdTipoPrescripcion, IdTipoPrescripcion).Load();
		...
		/// </summary>
		public static void Insert(string varNombre,int? varIdTipoPedido)
		{
		...
		/// </summary>
		public static void Update(int varIdTipoPrescripcion,string varNombre,int? varIdTipoPedido)
		{
			InsTipoPrescripcion item = new InsTipoPrescripcion();
        ...
        public void SetPKValues()
        {
                if (colInsDispensacionRecords != null)
                {
                    ...
                    {
                        if (item.IdTipoPrescripcion == null ||item.IdTipoPrescripcion != IdTipoPrescripcion)
                        {
