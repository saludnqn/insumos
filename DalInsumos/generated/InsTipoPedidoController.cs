...
namespace DalInsumos
{
    ...
    public partial class InsTipoPedidoController
    {
	    ...
	    public void Insert(string Nombre,bool Selected,int IdTipoMovimiento)
	    {
	    ...
	    public void Update(int IdTipoPedido,string Nombre,bool Selected,int IdTipoMovimiento)
	    {
		    InsTipoPedido item = new InsTipoPedido();
	        item.MarkOld();
	        item.IsLoaded = true;
