...
namespace DalInsumos
{
	...
	public partial class SysDepartamento : ActiveRecord<SysDepartamento>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Sys_Departamento", TableType.Table, DataService.GetInstance("insProvider"));
				...
				DataService.Providers["insProvider"].AddSchema("Sys_Departamento",schema);
			}
		}
		#endregion
		...
		public DalInsumos.SysPacienteCollection SysPacienteRecords
		{
			get
			{
				...
				{
					colSysPacienteRecords = new DalInsumos.SysPacienteCollection().Where(SysPaciente.Columns.IdDepartamento, IdDepartamento).Load();
