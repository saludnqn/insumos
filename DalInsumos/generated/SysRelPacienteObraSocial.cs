...
namespace DalInsumos
{
	...
	public partial class SysRelPacienteObraSocial : ActiveRecord<SysRelPacienteObraSocial>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Sys_RelPacienteObraSocial", TableType.Table, DataService.GetInstance("insProvider"));
				...
				DataService.Providers["insProvider"].AddSchema("Sys_RelPacienteObraSocial",schema);
			}
		}
		#endregion
