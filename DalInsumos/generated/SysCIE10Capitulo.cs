...
namespace DalInsumos
{
	...
	public partial class SysCIE10Capitulo : ActiveRecord<SysCIE10Capitulo>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Sys_CIE10Capitulo", TableType.Table, DataService.GetInstance("insProvider"));
				...
				DataService.Providers["insProvider"].AddSchema("Sys_CIE10Capitulo",schema);
			}
		}
		#endregion
