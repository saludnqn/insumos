...
namespace DalInsumos
{
    ...
    public partial class SysLocalidadController
    {
	    ...
	    public void Insert(string Nombre,int IdDepartamento,string CodigoPostal,string CodigoINDEC)
	    {
	    ...
	    public void Update(int IdLocalidad,string Nombre,int IdDepartamento,string CodigoPostal,string CodigoINDEC)
	    {
		    SysLocalidad item = new SysLocalidad();
	        item.MarkOld();
	        item.IsLoaded = true;
