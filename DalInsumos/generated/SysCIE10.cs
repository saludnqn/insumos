...
namespace DalInsumos
{
	...
	public partial class SysCIE10 : ActiveRecord<SysCIE10>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Sys_CIE10", TableType.Table, DataService.GetInstance("insProvider"));
				...
				colvarSinonimo.DataType = DbType.AnsiString;
				...
				DataService.Providers["insProvider"].AddSchema("Sys_CIE10",schema);
			}
		}
		#endregion
		...
		public DalInsumos.InsRecetumCollection InsReceta
		{
			get
			{
				...
				{
					colInsReceta = new DalInsumos.InsRecetumCollection().Where(InsRecetum.Columns.IdCODCie10, Id).Load();
		...
		void colInsReceta_ListChanged(object sender, ListChangedEventArgs e)
		{
		    if (e.ListChangedType == ListChangedType.ItemAdded)
		    {
		        ...
		        colInsReceta[e.NewIndex].IdCODCie10 = Id;
		    }
		}
		...
		public DalInsumos.InsDispensacionCollection InsDispensacionRecords
		{
			get
			{
				...
				{
					colInsDispensacionRecords = new DalInsumos.InsDispensacionCollection().Where(InsDispensacion.Columns.IdCODCie10, Id).Load();
		...
		void colInsDispensacionRecords_ListChanged(object sender, ListChangedEventArgs e)
		{
		    ...
		    {
		        // Set foreign key value
		        colInsDispensacionRecords[e.NewIndex].IdCODCie10 = Id;
		    }
		}
		...
		public DalInsumos.InsPrescripcionCollection InsPrescripcionRecords
		{
			get
			{
				...
				{
					colInsPrescripcionRecords = new DalInsumos.InsPrescripcionCollection().Where(InsPrescripcion.Columns.IdCODCie10, Id).Load();
		...
		void colInsPrescripcionRecords_ListChanged(object sender, ListChangedEventArgs e)
		{
		    ...
		    {
		        // Set foreign key value
		        colInsPrescripcionRecords[e.NewIndex].IdCODCie10 = Id;
		    }
		}
		...
		/// </summary>
		public static void Insert(string varCapitulo,string varGRUPOCIE10,string varCausa,string varSubcausa,string varCodigo,string varNombre,string varDescripCap,double? varModif,string varSinonimo,string varCepsap,bool varC2)
		{
		...
		/// </summary>
		public static void Update(int varId,string varCapitulo,string varGRUPOCIE10,string varCausa,string varSubcausa,string varCodigo,string varNombre,string varDescripCap,double? varModif,string varSinonimo,string varCepsap,bool varC2)
		{
			SysCIE10 item = new SysCIE10();
        ...
        public void SetPKValues()
        {
                if (colInsReceta != null)
                {
                    ...
                    {
                        if (item.IdCODCie10 == null ||item.IdCODCie10 != Id)
                        {
                            item.IdCODCie10 = Id;
                        }
                    }
