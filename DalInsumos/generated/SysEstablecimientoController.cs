...
namespace DalInsumos
{
    ...
    public partial class SysEstablecimientoController
    {
	    ...
	    public void Insert(int IdEstablecimiento,string Localidad,string Nombre,int IdZona,int? IdLocalidad)
	    {
	    ...
	    public void Update(int IdEstablecimiento,string Localidad,string Nombre,int IdZona,int? IdLocalidad)
	    {
		    SysEstablecimiento item = new SysEstablecimiento();
	        item.MarkOld();
	        item.IsLoaded = true;
