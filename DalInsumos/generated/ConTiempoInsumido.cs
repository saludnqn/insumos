...
namespace DalInsumos
{
	...
	public partial class ConTiempoInsumido : ActiveRecord<ConTiempoInsumido>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("CON_TiempoInsumido", TableType.Table, DataService.GetInstance("insProvider"));
				...
				DataService.Providers["insProvider"].AddSchema("CON_TiempoInsumido",schema);
			}
		}
		#endregion
