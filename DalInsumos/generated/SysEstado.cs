...
namespace DalInsumos
{
	...
	public partial class SysEstado : ActiveRecord<SysEstado>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Sys_Estado", TableType.Table, DataService.GetInstance("insProvider"));
				...
				DataService.Providers["insProvider"].AddSchema("Sys_Estado",schema);
			}
		}
		#endregion
		...
		public DalInsumos.SysPacienteCollection SysPacienteRecords
		{
			get
			{
				...
				{
					colSysPacienteRecords = new DalInsumos.SysPacienteCollection().Where(SysPaciente.Columns.IdEstado, IdEstado).Load();
		...
		private DalInsumos.SysRelEstadoMotivoNICollection colSysRelEstadoMotivoNIRecords;
		public DalInsumos.SysRelEstadoMotivoNICollection SysRelEstadoMotivoNIRecords
		{
			get
			{
				if(colSysRelEstadoMotivoNIRecords == null)
				{
					colSysRelEstadoMotivoNIRecords = new DalInsumos.SysRelEstadoMotivoNICollection().Where(SysRelEstadoMotivoNI.Columns.IdEstado, IdEstado).Load();
        ...
        public void SetPKValues()
        {
                ...
                if (colSysRelEstadoMotivoNIRecords != null)
                {
                    foreach (DalInsumos.SysRelEstadoMotivoNI item in colSysRelEstadoMotivoNIRecords)
                    {
                        if (item.IdEstado != IdEstado)
                        {
                            item.IdEstado = IdEstado;
