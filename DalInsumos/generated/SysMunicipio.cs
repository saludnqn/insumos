...
namespace DalInsumos
{
	...
	public partial class SysMunicipio : ActiveRecord<SysMunicipio>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Sys_Municipio", TableType.Table, DataService.GetInstance("insProvider"));
				...
				DataService.Providers["insProvider"].AddSchema("Sys_Municipio",schema);
			}
		}
		#endregion
