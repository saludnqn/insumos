...
namespace DalInsumos
{
    ...
    public partial class SysCIE10Controller
    {
	    ...
	    public void Insert(string Capitulo,string GRUPOCIE10,string Causa,string Subcausa,string Codigo,string Nombre,string DescripCap,double? Modif,string Sinonimo,string Cepsap,bool C2)
	    {
	    ...
	    public void Update(int Id,string Capitulo,string GRUPOCIE10,string Causa,string Subcausa,string Codigo,string Nombre,string DescripCap,double? Modif,string Sinonimo,string Cepsap,bool C2)
	    {
		    SysCIE10 item = new SysCIE10();
	        item.MarkOld();
	        item.IsLoaded = true;
