...
namespace DalInsumos
{
	...
	public partial class SysIdioma : ActiveRecord<SysIdioma>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Sys_Idioma", TableType.Table, DataService.GetInstance("insProvider"));
				...
				DataService.Providers["insProvider"].AddSchema("Sys_Idioma",schema);
			}
		}
		#endregion
