...
namespace DalInsumos
{
	...
	public partial class SysModulo : ActiveRecord<SysModulo>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Sys_Modulo", TableType.Table, DataService.GetInstance("insProvider"));
				...
				DataService.Providers["insProvider"].AddSchema("Sys_Modulo",schema);
			}
		}
		#endregion
		...
		private DalInsumos.SysMenuCollection colSysMenuRecords;
		public DalInsumos.SysMenuCollection SysMenuRecords
		{
			get
			{
				if(colSysMenuRecords == null)
				{
					colSysMenuRecords = new DalInsumos.SysMenuCollection().Where(SysMenu.Columns.IdModulo, IdModulo).Load();
        ...
        public void SetPKValues()
        {
                if (colSysMenuRecords != null)
                {
                    foreach (DalInsumos.SysMenu item in colSysMenuRecords)
                    {
