...
namespace DalInsumos
{
	...
	public partial class SysRelServicioEfector : ActiveRecord<SysRelServicioEfector>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Sys_RelServicioEfector", TableType.Table, DataService.GetInstance("insProvider"));
				...
				DataService.Providers["insProvider"].AddSchema("Sys_RelServicioEfector",schema);
			}
		}
		#endregion
