...
namespace DalInsumos
{
	...
	public partial class SysMotivoNI : ActiveRecord<SysMotivoNI>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Sys_MotivoNI", TableType.Table, DataService.GetInstance("insProvider"));
				...
				DataService.Providers["insProvider"].AddSchema("Sys_MotivoNI",schema);
			}
		}
		#endregion
		...
		public DalInsumos.SysPacienteCollection SysPacienteRecords
		{
			get
			{
				...
				{
					colSysPacienteRecords = new DalInsumos.SysPacienteCollection().Where(SysPaciente.Columns.IdMotivoNI, IdMotivoNI).Load();
