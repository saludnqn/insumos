...
namespace DalInsumos
{
	...
	public partial class SysPerfil : ActiveRecord<SysPerfil>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Sys_Perfil", TableType.Table, DataService.GetInstance("insProvider"));
				...
				colvarFechaActualizacion.IsReadOnly = false;
						...
						colvarFechaActualizacion.DefaultSetting = @"('01/01/1900')";
				...
				DataService.Providers["insProvider"].AddSchema("Sys_Perfil",schema);
			}
		}
		#endregion
		...
		public DalInsumos.SysUsuarioCollection SysUsuarioRecords
		{
			get
			{
				...
				{
					colSysUsuarioRecords = new DalInsumos.SysUsuarioCollection().Where(SysUsuario.Columns.IdPerfil, IdPerfil).Load();
		...
		private DalInsumos.SysPermisoCollection colSysPermisoRecords;
		public DalInsumos.SysPermisoCollection SysPermisoRecords
		{
			get
			{
				if(colSysPermisoRecords == null)
				{
					colSysPermisoRecords = new DalInsumos.SysPermisoCollection().Where(SysPermiso.Columns.IdPerfil, IdPerfil).Load();
        ...
        public void SetPKValues()
        {
                ...
                if (colSysPermisoRecords != null)
                {
                    foreach (DalInsumos.SysPermiso item in colSysPermisoRecords)
                    {
                        if (item.IdPerfil != IdPerfil)
                        {
                            item.IdPerfil = IdPerfil;
