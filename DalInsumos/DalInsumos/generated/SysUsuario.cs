...
namespace DalInsumos
{
	...
	public partial class SysUsuario : ActiveRecord<SysUsuario>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Sys_Usuario", TableType.Table, DataService.GetInstance("insProvider"));
				...
				TableSchema.TableColumn colvarFirmaValidacion = new TableSchema.TableColumn(schema);
				colvarFirmaValidacion.ColumnName = "firmaValidacion";
				colvarFirmaValidacion.DataType = DbType.String;
				colvarFirmaValidacion.MaxLength = 500;
				colvarFirmaValidacion.AutoIncrement = false;
				colvarFirmaValidacion.IsNullable = false;
				colvarFirmaValidacion.IsPrimaryKey = false;
				colvarFirmaValidacion.IsForeignKey = false;
				colvarFirmaValidacion.IsReadOnly = false;
				
						colvarFirmaValidacion.DefaultSetting = @"('')";
				colvarFirmaValidacion.ForeignKeyTableName = "";
				schema.Columns.Add(colvarFirmaValidacion);
				...
				DataService.Providers["insProvider"].AddSchema("Sys_Usuario",schema);
			}
		}
		#endregion
		...
		[XmlAttribute("FirmaValidacion")]
		[Bindable(true)]
		public string FirmaValidacion 
		{
			get { return GetColumnValue<string>(Columns.FirmaValidacion); }
			set { SetColumnValue(Columns.FirmaValidacion, value); }
		}
		...
		/// 
		/// </summary>
		public DalInsumos.SysPerfil SysPerfil
		{
			get { return DalInsumos.SysPerfil.FetchByID(this.IdPerfil); }
		...
		/// </summary>
		public static void Insert(int varIdEfector,int varIdPerfil,string varApellido,string varNombre,string varLegajo,string varUsername,string varPassword,bool varActivo,int varIdUsuarioActualizacion,DateTime varFechaActualizacion,string varFirmaValidacion,string varEmail,string varTelefono,string varObservacion,int varDocumento)
		{
			...
			item.FirmaValidacion = varFirmaValidacion;
        ...
        public static TableSchema.TableColumn FirmaValidacionColumn
        {
		...
		public struct Columns
		{
			 ...
			 public static string FirmaValidacion = @"firmaValidacion";
