...
namespace DalInsumos
{
	...
	public partial class SysAntecedente : ActiveRecord<SysAntecedente>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Sys_Antecedente", TableType.Table, DataService.GetInstance("insProvider"));
				...
				DataService.Providers["insProvider"].AddSchema("Sys_Antecedente",schema);
			}
		}
		#endregion
		...
		public DalInsumos.SysRelAntecedentePacienteCollection SysRelAntecedentePacienteRecords
		{
			get
			{
				...
				{
					colSysRelAntecedentePacienteRecords = new DalInsumos.SysRelAntecedentePacienteCollection().Where(SysRelAntecedentePaciente.Columns.IdAntecedente, IdAntecedente).Load();
