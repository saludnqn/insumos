...
namespace DalInsumos
{
	...
	public partial class SysHistoriaClinica : ActiveRecord<SysHistoriaClinica>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Sys_HistoriaClinica", TableType.Table, DataService.GetInstance("insProvider"));
				...
				DataService.Providers["insProvider"].AddSchema("Sys_HistoriaClinica",schema);
			}
		}
		#endregion
