...
namespace DalInsumos
{
	...
	public partial class SysRelHistoriaClinicaEfector : ActiveRecord<SysRelHistoriaClinicaEfector>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Sys_RelHistoriaClinicaEfector", TableType.Table, DataService.GetInstance("insProvider"));
				...
				DataService.Providers["insProvider"].AddSchema("Sys_RelHistoriaClinicaEfector",schema);
			}
		}
		#endregion
