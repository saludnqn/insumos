...
namespace DalInsumos
{
	...
	public partial class SysRelProfesionalEfector : ActiveRecord<SysRelProfesionalEfector>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Sys_RelProfesionalEfector", TableType.Table, DataService.GetInstance("insProvider"));
				...
				DataService.Providers["insProvider"].AddSchema("Sys_RelProfesionalEfector",schema);
			}
		}
		#endregion
