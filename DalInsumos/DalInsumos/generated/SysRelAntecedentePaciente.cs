...
namespace DalInsumos
{
	...
	public partial class SysRelAntecedentePaciente : ActiveRecord<SysRelAntecedentePaciente>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Sys_RelAntecedentePaciente", TableType.Table, DataService.GetInstance("insProvider"));
				...
				DataService.Providers["insProvider"].AddSchema("Sys_RelAntecedentePaciente",schema);
			}
		}
		#endregion
		...
		/// 
		/// </summary>
		public DalInsumos.SysAntecedente SysAntecedente
		{
			get { return DalInsumos.SysAntecedente.FetchByID(this.IdAntecedente); }
