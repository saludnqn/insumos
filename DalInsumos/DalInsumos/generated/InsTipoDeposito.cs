...
namespace DalInsumos
{
	...
	public partial class InsTipoDeposito : ActiveRecord<InsTipoDeposito>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("INS_TipoDeposito", TableType.Table, DataService.GetInstance("insProvider"));
				...
				DataService.Providers["insProvider"].AddSchema("INS_TipoDeposito",schema);
			}
		}
		#endregion
		...
		public DalInsumos.InsDepositoCollection InsDepositoRecords
		{
			get
			{
				...
				{
					colInsDepositoRecords = new DalInsumos.InsDepositoCollection().Where(InsDeposito.Columns.IdTipoDeposito, IdTipoDeposito).Load();
