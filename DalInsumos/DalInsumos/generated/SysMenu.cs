...
namespace DalInsumos
{
	...
	public partial class SysMenu : ActiveRecord<SysMenu>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Sys_Menu", TableType.Table, DataService.GetInstance("insProvider"));
				...
				DataService.Providers["insProvider"].AddSchema("Sys_Menu",schema);
			}
		}
		#endregion
		...
		/// 
		/// </summary>
		public DalInsumos.SysModulo SysModulo
		{
			get { return DalInsumos.SysModulo.FetchByID(this.IdModulo); }
