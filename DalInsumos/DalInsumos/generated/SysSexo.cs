...
namespace DalInsumos
{
	...
	public partial class SysSexo : ActiveRecord<SysSexo>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Sys_Sexo", TableType.Table, DataService.GetInstance("insProvider"));
				...
				DataService.Providers["insProvider"].AddSchema("Sys_Sexo",schema);
			}
		}
		#endregion
		...
		public DalInsumos.SysPacienteCollection SysPacienteRecords
		{
			get
			{
				...
				{
					colSysPacienteRecords = new DalInsumos.SysPacienteCollection().Where(SysPaciente.Columns.IdSexo, IdSexo).Load();
