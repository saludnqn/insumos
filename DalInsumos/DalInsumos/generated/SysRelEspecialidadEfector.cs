...
namespace DalInsumos
{
	...
	public partial class SysRelEspecialidadEfector : ActiveRecord<SysRelEspecialidadEfector>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Sys_RelEspecialidadEfector", TableType.Table, DataService.GetInstance("insProvider"));
				...
				DataService.Providers["insProvider"].AddSchema("Sys_RelEspecialidadEfector",schema);
			}
		}
		#endregion
		...
		/// 
		/// </summary>
		public DalInsumos.SysEspecialidad SysEspecialidad
		{
			get { return DalInsumos.SysEspecialidad.FetchByID(this.IdEspecialidad); }
