...
namespace DalInsumos
{
	...
	public partial class SysPacienteCeliaco : ActiveRecord<SysPacienteCeliaco>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Sys_PacienteCeliaco", TableType.Table, DataService.GetInstance("insProvider"));
				...
				DataService.Providers["insProvider"].AddSchema("Sys_PacienteCeliaco",schema);
			}
		}
		#endregion
