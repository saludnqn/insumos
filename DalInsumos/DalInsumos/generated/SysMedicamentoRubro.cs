...
namespace DalInsumos
{
	...
	public partial class SysMedicamentoRubro : ActiveRecord<SysMedicamentoRubro>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Sys_MedicamentoRubro", TableType.Table, DataService.GetInstance("insProvider"));
				...
				DataService.Providers["insProvider"].AddSchema("Sys_MedicamentoRubro",schema);
			}
		}
		#endregion
		...
		private DalInsumos.SysMedicamentoCollection colSysMedicamentoRecords;
		public DalInsumos.SysMedicamentoCollection SysMedicamentoRecords
		{
			get
			{
				if(colSysMedicamentoRecords == null)
				{
					colSysMedicamentoRecords = new DalInsumos.SysMedicamentoCollection().Where(SysMedicamento.Columns.IdMedicamentoRubro, IdMedicamentoRubro).Load();
        ...
        public void SetPKValues()
        {
                if (colSysMedicamentoRecords != null)
                {
                    foreach (DalInsumos.SysMedicamento item in colSysMedicamentoRecords)
                    {
