...
namespace DalInsumos
{
	...
	public partial class SysServicio : ActiveRecord<SysServicio>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Sys_Servicio", TableType.Table, DataService.GetInstance("insProvider"));
				...
				DataService.Providers["insProvider"].AddSchema("Sys_Servicio",schema);
			}
		}
		#endregion
		...
		public DalInsumos.InsDepositoCollection InsDepositoRecords
		{
			get
			{
				...
				{
					colInsDepositoRecords = new DalInsumos.InsDepositoCollection().Where(InsDeposito.Columns.IdServicio, IdServicio).Load();
		...
		void colInsDepositoRecords_ListChanged(object sender, ListChangedEventArgs e)
		{
		    if (e.ListChangedType == ListChangedType.ItemAdded)
		    {
		        ...
		        colInsDepositoRecords[e.NewIndex].IdServicio = IdServicio;
		    }
		}
		...
		public DalInsumos.SysRelServicioEfectorCollection SysRelServicioEfectorRecords
		{
			get
			{
				...
				{
					colSysRelServicioEfectorRecords = new DalInsumos.SysRelServicioEfectorCollection().Where(SysRelServicioEfector.Columns.IdServicio, IdServicio).Load();
		...
		/// </summary>
		public static void Insert(int varIdServicio,string varNombre,string varUnidadOperativa,bool varActivo)
		{
