...
namespace DalInsumos
{
	...
	public partial class SysDireccione : ActiveRecord<SysDireccione>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Sys_Direcciones", TableType.Table, DataService.GetInstance("insProvider"));
				...
				DataService.Providers["insProvider"].AddSchema("Sys_Direcciones",schema);
			}
		}
		#endregion
