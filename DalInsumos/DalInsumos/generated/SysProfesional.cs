...
namespace DalInsumos
{
	...
	public partial class SysProfesional : ActiveRecord<SysProfesional>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Sys_Profesional", TableType.Table, DataService.GetInstance("insProvider"));
				...
				DataService.Providers["insProvider"].AddSchema("Sys_Profesional",schema);
			}
		}
		#endregion
		...
		public DalInsumos.InsDispensacionCollection InsDispensacionRecords
		{
			get
			{
				...
				{
					colInsDispensacionRecords = new DalInsumos.InsDispensacionCollection().Where(InsDispensacion.Columns.IdProfesional, IdProfesional).Load();
		...
		void colInsDispensacionRecords_ListChanged(object sender, ListChangedEventArgs e)
		{
		    if (e.ListChangedType == ListChangedType.ItemAdded)
		    {
		        ...
		        colInsDispensacionRecords[e.NewIndex].IdProfesional = IdProfesional;
		    }
		}
		...
		public DalInsumos.InsPrescripcionCollection InsPrescripcionRecords
		{
			get
			{
				...
				{
					colInsPrescripcionRecords = new DalInsumos.InsPrescripcionCollection().Where(InsPrescripcion.Columns.IdProfesional, IdProfesional).Load();
		...
		void colInsPrescripcionRecords_ListChanged(object sender, ListChangedEventArgs e)
		{
		    ...
		    {
		        // Set foreign key value
		        colInsPrescripcionRecords[e.NewIndex].IdProfesional = IdProfesional;
		    }
		}
		...
		public DalInsumos.InsRecetumCollection InsReceta
		{
			get
			{
				...
				{
					colInsReceta = new DalInsumos.InsRecetumCollection().Where(InsRecetum.Columns.IdProfesional, IdProfesional).Load();
		...
		void colInsReceta_ListChanged(object sender, ListChangedEventArgs e)
		{
		    ...
		    {
		        // Set foreign key value
		        colInsReceta[e.NewIndex].IdProfesional = IdProfesional;
		    }
		}
		...
		public DalInsumos.SysRelProfesionalEfectorCollection SysRelProfesionalEfectorRecords
		{
			get
			{
				...
				{
					colSysRelProfesionalEfectorRecords = new DalInsumos.SysRelProfesionalEfectorCollection().Where(SysRelProfesionalEfector.Columns.IdProfesional, IdProfesional).Load();
        ...
        public void SetPKValues()
        {
                if (colInsDispensacionRecords != null)
                {
                    ...
                    {
                        if (item.IdProfesional == null ||item.IdProfesional != IdProfesional)
                        {
